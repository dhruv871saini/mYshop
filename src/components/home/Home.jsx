...
import CateBox from "./CateBox.jsx/CateBox";
...
const Home = () => {
  ...
  return (
    <div className="overflow">
      ...
      <Slider />
      <div>{/* <Slider /> */}</div>
      {/* <div className="my-5"><CateBox/></div> */}
      <div className="container-fluid bg-clr mt-5">
          ...
          <div className="col-md-4">
            <SectionWithAnimation>
              <div className="d-flex">
                ...
                <div className="fs-3 fw-bold mx-3">
                  Free Shipping
                  <div className="fs-5 ">Free Shipping On Order Over $299</div>
                </div>
              </div>
            </SectionWithAnimation>
          </div>
          <div className="col-md-4">
            <SectionWithAnimation>
              <div className="d-flex">
                ...
                <div className="fs-3 fw-bold mx-3">
                  Customer Support
                  <div className="fs-5 ">Instant Access To Perfect Support</div>
                </div>
              </div>
            </SectionWithAnimation>
          </div>
          <div className="col-md-4">
            <SectionWithAnimation>
              <div className="d-flex">
                ...
                <div className="fs-3 fw-bold mx-3">
                  100% Secure Payment
                  <div className="fs-5 ">We Ensure Secure Payment</div>
                </div>
              </div>
            </SectionWithAnimation>
          </div>
...

      {
        <div class="container-fluid text-center fs-2 text-primary">
          <marquee
            behavior="scroll"
            direction="left"
            className="skewed-container fw-bold display-5 "
          >
          ...
          <SectionWithAnimation>
            <div className="col d-flex flex-wrap justify-content-center">
              {first.map((item, index) => (
                <div
                  className="col-md-3 mb-4 card-container" // Add the card-container class here
                  key={index}
                  style={{ paddingTop: "2%", position: "relative" }} // Ensure position relative for card-container
                >
                  <Card
                    raised
                    sx={{
                  ...
                  >
                    <CardMedia
                      ...
                      className="card-image" // Apply the custom class here
                    />
                    <CardContent>
                      <Typography
                        gutterBottom
                      ...
                      <Typography variant="body2" color="text-secondary" sx={{paddingBottom:"35px"}}>
                        {item.description.substring(0, 100)}
                      </Typography>
                    </CardContent>
                    <div className="card-actions">
                      {" "}
                      {/* Add card-actions class here */}
                      <CardActions>
                        <input
                          type="submit"
                          value="Add To Cart"
